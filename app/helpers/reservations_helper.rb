module ReservationsHelper
  ...
  def time_field_class(reservation, field_name)
    base_classes = "bg-white border border-gray-300 text-gray-900 text-sm sm:text-lg rounded-lg focus:ring-primary focus:border-primary block w-full pl-8 sm:pl-10 p-2 sm:p-2.5"
